...
let autoRotateSpeed = 0.3; // Ajuste a velocidade aqui
...
btnPopup.addEventListener('click', () => {
    ...
    wrapper.style.marginTop = '20px'; // Ajusta a posição do formulário
});

closeIcon.addEventListener('click', () => {
    wrapper.classList.remove('active-btnPopup');
    wrapper.style.marginTop = '-520px'; // Esconde o formulário
});
